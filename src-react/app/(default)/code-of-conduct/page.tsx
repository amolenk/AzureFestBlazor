...
export const metadata = {
  title: "Code of Conduct | Azure Fest"
};

export default function CodeOfConductPage() {
  return (
    <MainLayout>
      <Section headerText="Code of Conduct">
        <p>
          All attendees, speakers, sponsors and volunteers at Azure Fest are required to agree with the
        ...
        <p>
          Azure Fest is dedicated to providing a harassment-free conference experience for everyone,
          ...
          or expelled from the conference at the discretion of the conference organisers.
        </p>
        ...
        <p>
          ...
          deem appropriate, including warning the offender or expulsion from the conference.
        </p>

        <p>
          If you are being harassed, notice that someone else is being harassed, or have any other concerns,
          please contact a member of conference staff immediately. Conference staff can be identified as
          they&apos;ll be wearing Azure Fest branded clothing.
        </p>
        ...
        <h2>Photography at the Event</h2>

        <p>
          We will have a professional photographer present at our event. The photographer will be taking
          photos throughout the event&apos;s duration, capturing the essence of the event, the enthusiasm of
          the attendees, and various activities and sessions.
        </p>

        <p>
          The photographs taken may be used in future promotional materials, social media posts, and other
          publications to showcase the event and promote future gatherings. By attending this event, you
          acknowledge and agree to the possibility of being photographed.
        </p>

        <p>
          (Code of conduct based on <a href="https://confcodeofconduct.com/">Conference Code of Conduct</a>)
        </p>
      </Section>
    </MainLayout>
  );
